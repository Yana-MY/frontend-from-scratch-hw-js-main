...
//   }
//   // Если длина меньше или равна максимальной, возвращаем исходную строку
//   return str;
// }
...
// console.log(truncate("Это тестовая строка.", 10)); // Ожидаемый результат: "Это тесто..."

function truncate(str, maxLength) {
  // Проверяем, если длина строки больше максимальной длины
  if (str.length > maxLength) {
    // Обрезаем строку до максимальной длины и добавляем многоточие
